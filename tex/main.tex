...
\title{Recognition of russian postal address elements using artificial neural networks}
...
\maketitle
\begin{abstract}
    This documents provides result of research for named entity recognition task applied to russian postal address parts.
    A postal address can be written in various forms, with missed parts or typos.
    The task is to recognize elements of address like postal index, region, place, street, recipient, etc using artificial neural networks.
    The source code available at
     \url{https://github.com/qwazer/postal-address-ner}.
\end{abstract}
